...
def main():
    ...
    # Create objects
    client.put_object(bucket_name, "my-object-1", io.BytesIO(b"hello"), 5,)
    client.put_object(bucket_name, "my-object-2", io.BytesIO(b"hello"), 5,)
    r = client.put_object(bucket_name, "my-object-2", io.BytesIO(b"hi"), 2,)
    client.put_object(bucket_name, "my-object-2", io.BytesIO(b"goodbye"), 7,)
    ver = r.version_id

    # Remove object.
    client.remove_object(bucket_name, "my-object-1")

    # Remove version of an object.
    client.remove_object(
        bucket_name, "my-object-2",
        version_id=ver,
    )
