...
check:
	...
	@if python --version | grep -qi 'python 3'; then pylint --reports=no minio/copy_conditions.py minio/definitions.py minio/parsers.py minio/post_policy.py minio/signer.py minio/__init__.py minio/select; fi
